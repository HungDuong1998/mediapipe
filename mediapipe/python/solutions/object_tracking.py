...
"""MediaPipe Object Tracking Detection."""
...
from mediapipe.calculators.video import box_tracker_calculator_pb2
from mediapipe.calculators.video import flow_packager_calculator_pb2
from mediapipe.calculators.video import motion_analysis_calculator_pb2
from mediapipe.calculators.video import tracked_detection_manager_calculator_pb2
from mediapipe.calculators.core import packet_resampler_calculator_pb2
from mediapipe.framework.stream_handler import sync_set_input_stream_handler_pb2
# pylint: enable=unused-import
from mediapipe.python.solutions import download_utils
from mediapipe.python.solution_base import SolutionBase

BINARYPB_FILE_PATH = 'mediapipe/modules/object_tracking/object_detection_tracking_cpu.binarypb'
...
class ObjectDetectionTracking(SolutionBase):
    ...
    def __init__(self, max_object_detection=3,
        ...
        """Initializes a MediaPipe Object Detection Tracking object.
        ...
        super().__init__(
            ...
            calculator_params={
                'objectdetectionsubgraphcpu__TfLiteTensorsToDetectionsCalculator.min_score_thresh':
                    min_detection_confidence,
                'objectdetectionsubgraphcpu__NonMaxSuppressionCalculator.min_suppression_threshold':
                    min_suppression_threshold,
                'objectdetectionsubgraphcpu__NonMaxSuppressionCalculator.max_num_detections':
                    max_object_detection,
            },
            outputs=['tracked_detections'])
